...
A software engineering internship doing graphics, rendering, or performance work. Close to the hardware, somewhere I can measure whether I did it well, shipping something real next to engineers I can learn from.

That's narrower than what I'd have said a year ago, and wider than it sounds. Graphics, GPU compute, simulation and ML inference all come down to the same skill: getting a lot of parallel work done inside a budget. I'd rather get good at that than pick an industry and hope it's the right one.
...
I've loved video games my whole life, and graphics is where that runs into the hard-problem stuff. It's one of the few places low-level work shows up right on the screen. Get it right and you watch it run, instead of reading it off a graph.
...
I like being close to hardware. I built my PC years ago and keep tuning it. Lately I've been into small form factor builds, trying to fit real performance into a roughly 10-liter case. I also fell down the audio rabbit hole: EQ, calibration, measuring how speakers and headphones actually perform. I keep meaning to write my own AutoEQ-style tool and haven't started. I'm in UCSC's Game Design and Art club making things in Godot. And Rust is my default when I want speed and safety at once.
...
**University (2024 to now).** Computer science at UC Santa Cruz, going into my third year. Building systems-level projects across graphics, GPU compute and infrastructure, and looking for a software engineering internship where performance is the actual problem.
